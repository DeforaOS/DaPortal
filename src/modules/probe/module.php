		...
		switch($request->get('type'))
		{
			case 'load':
				...
				$rrdtool .= ' --lower-limit 0.0'
					...
					.' '.escapeshellarg('CDEF:r3load1=rload1,3,/')
					.' '.escapeshellarg('CDEF:r3load5=rload5,3,/')
					.' '.escapeshellarg('CDEF:r3load15=rload15,3,/')
					.' '.escapeshellarg('AREA:r3load15#ff8f00')
					.' '.escapeshellarg('STACK:r3load5#ffbf00')
					.' '.escapeshellarg('STACK:r3load1#ffef00')
